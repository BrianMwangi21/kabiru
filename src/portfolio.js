  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Building responsive website front end using ReactJS and VueJS and IONIC",
        "⚡ Creating application backend in Node, Express, Spring Boot & Flask",
  ...
  degrees: [
    {
      ...
      descriptions: [
        "⚡ I have studied core subjects like Advanced Database Systems, Software Modeling, Business Ethics etc.",
        "⚡ I have also started on a thesis about Non-Fungible Tokens based on Blockchain technology.",
      ],
      website_link:
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of the latest technology tools. My best experience is to create NodeJS Backend Projects, Python Scripts, and React Projects. I have also dipped my feet into some AI and blockchain as well and I am loving it. Check them out below and remember - more are coming soon 👌",
